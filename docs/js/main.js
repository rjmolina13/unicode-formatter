	...
	fonts: {
		...
		init: function(textarea) {
			...
			this.CodeMirror = CodeMirror.fromTextArea(textarea, {
				...
				const eraser = () => formatSelection("normal");
				const bold = () => formatSelection("sansBold");
				const bolditalic = () => formatSelection("sansBoldItalic");
				const serfsital = () => formatSelection("serifItalic");
				const serfsbold = () => formatSelection("serifBold");
				const sbolditalic = () => formatSelection("serifBoldItalic");
				const italic = () => formatSelection("sansItalic");
				const monospace = () => formatSelection("monospace");
				const strikethrough = () => formatSelection("", "̶");
				const underline = () => formatSelection("", "͟");
				const superscript = () => formatSelection("superscript");
				const subscript = () => formatSelection("subscript");				
				document.addEventListener("keydown", function(e) {
					// Check for Ctrl or Meta (Cmd/Windows) + Shift + X
				...
				document.addEventListener("keydown", function(e) {
					// Check for Ctrl or Meta (Cmd/Windows) + Alt + B
				...
				document.addEventListener("keydown", function(e) {
					// Check for Ctrl or Meta (Cmd/Windows) + Shift + Z
				...
				document.addEventListener("keydown", function(e) {
					// Check for Ctrl or Meta (Cmd/Windows) + Shift + Alt + I
